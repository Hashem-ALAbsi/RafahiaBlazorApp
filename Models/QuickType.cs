...
namespace RafahiaBlazorApp.Models
{
    ...
    public partial class YemenInfo
    {
    ...
    public partial class YemenInfo
    {
        public static YemenInfo FromJson(string json) => JsonConvert.DeserializeObject<YemenInfo>(json, RafahiaBlazorApp.Models.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this YemenInfo self) => JsonConvert.SerializeObject(self, RafahiaBlazorApp.Models.Converter.Settings);
    }
